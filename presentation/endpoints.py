...
from .utils import (build_context, list_response, details_response,
                    delete_response, creation_response, edit_response)
...
def client_edit(id):
    ...
    return edit_response(Client, id, ClientForm, g.db_session, _mapping,
                             'client/edit.html', 'client_list')
...
def employee_edit(id):
    ...
    return edit_response(Employee, id, EmployeeForm, g.db_session, _mapping,
                             'employee/edit.html', 'employee_list') 
...
def credit_card_edit(id):
    ...
    return edit_response(CreditCard, id, CreditCardForm, g.db_session, _mapping,
                             'credit_card/edit.html', 'credit_card_list') 
...
def live_action_series_edit(id):
    def _mapping(form, obj):
        # rentables
        obj.setTitle(form.title.data)
        obj.setDescription(form.description.data)
    ...
    return edit_response(LiveActionSeries, id, LiveActionSeriesForm, g.db_session, _mapping,
                             'rentable/live_action_series/edit.html', 'live_action_series_list')
...
def animated_series_edit(id):
    ...
    return edit_response(AnimatedSeries, id, AnimatedSeriesForm, g.db_session, _mapping,
                             'rentable/animated_series/edit.html', 'animated_series_list')
...
def documentary_series_edit(id):
    def _mapping(form, obj):
        # rentables
        obj.setTitle(form.title.data)
        obj.setDescription(form.description.data)
    ...
    return edit_response(DocumentarySeries, id, DocumentarySeriesForm, g.db_session, _mapping,
                             'rentable/documentary_series/edit.html', 'documentary_series_list')
...
def stand_up_comedy_special_edit(id):
    def _mapping(form, obj):
        # rentables
        obj.setTitle(form.title.data)
        obj.setDescription(form.description.data)
    ...
    return edit_response(StandUpComedySpecial, id, StandUpComedySpecialForm, g.db_session, _mapping,
                             'rentable/stand_up_comedy_special/edit.html', 'stand_up_comedy_special_list')
...
def live_action_movie_edit(id):
    ...
    return edit_response(LiveActionMovie, id, LiveActionMovieForm, g.db_session, _mapping,
                             'rentable/live_action_movie/edit.html', 'live_action_movie_list')
...
def animated_movie_edit(id):
    ...
    return edit_response(AnimatedMovie, id, AnimatedMovieForm, g.db_session, _mapping,
                             'rentable/animated_movie/edit.html', 'animated_movie_list')
...
def musical_show_edit(id):
    ...
    return edit_response(MusicalShow, id, MusicalShowForm, g.db_session, _mapping,
                             'rentable/musical_show/edit.html', 'musical_show_list')
...
def documentary_edit(id):
    ...
    return edit_response(Documentary, id, DocumentaryForm, g.db_session, _mapping,
                             'rentable/documentary/edit.html', 'documentary_list')
...
def video_game_edit(id):
    ...
    return edit_response(VideoGame, id, VideoGameForm, g.db_session, _mapping,
                             'rentable/video_game/edit.html', 'video_game_list')
...
def sports_event_edit(id):
    ...
    return edit_response(SportsEvent, id, SportsEventForm, g.db_session, _mapping,
                             'rentable/sports_event/edit.html', 'sports_event_list')
