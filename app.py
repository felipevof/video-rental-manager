...
app.add_url_rule('/clients/<id>/edit', 'client_edit', client_edit, methods=['GET', 'POST'])
...
app.add_url_rule('/employees/<id>/edit', 'employee_edit', employee_edit, methods=['GET', 'POST'])
...
app.add_url_rule('/credit_cards/<id>/edit', 'credit_card_edit', credit_card_edit, methods=['GET', 'POST'])
...
app.add_url_rule('/rentals/<id>/edit', 'rental_event_edit', rental_event_edit, methods=['GET', 'POST'])
...
app.add_url_rule('/live_action_series/<id>/edit', 'live_action_series_edit', live_action_series_edit, methods=['GET', 'POST'])
...
app.add_url_rule('/animated_series/<id>/edit', 'animated_series_edit', animated_series_edit, methods=['GET', 'POST'])
...
app.add_url_rule('/documentary_series/<id>/edit', 'documentary_series_edit', documentary_series_edit, methods=['GET', 'POST'])
...
app.add_url_rule('/stand_up_comedy_specials/<id>/edit', 'stand_up_comedy_special_edit', stand_up_comedy_special_edit, methods=['GET', 'POST'])
...
app.add_url_rule('/live_action_movies/<id>/edit', 'live_action_movie_edit', live_action_movie_edit, methods=['GET', 'POST'])
...
app.add_url_rule('/animated_movies/<id>/edit', 'animated_movie_edit', animated_movie_edit, methods=['GET', 'POST'])
...
app.add_url_rule('/musical_shows/<id>/edit', 'musical_show_edit', musical_show_edit, methods=['GET', 'POST'])
...
app.add_url_rule('/documentaries/<id>/edit', 'documentary_edit', documentary_edit, methods=['GET', 'POST'])
...
app.add_url_rule('/video_games/<id>/edit', 'video_game_edit', video_game_edit, methods=['GET', 'POST'])
...
app.add_url_rule('/sports_events/<id>/edit', 'sports_event_edit', sports_event_edit, methods=['GET', 'POST'])
